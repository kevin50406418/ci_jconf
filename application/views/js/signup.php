	...
	$("#register").validate({
		...
		messages:{
			...
			user_email:{
				...
				remote: jQuery.validator.format("<?php echo lang('user_email_remote')?>"),
			},
			user_phoneO_1:{
				required: "<?php echo lang('user_phoneO_1_required')?>",
				maxlength: "<?php echo lang('user_phoneO_1_maxlength')?>",
				number: "<?php echo lang('user_phoneO_1_number')?>"
			},
			user_phoneO_2:{
				required: "<?php echo lang('user_phoneO_2_required')?>",
				maxlength: "<?php echo lang('user_phoneO_2_maxlength')?>",
				number: "<?php echo lang('user_phoneO_2_number')?>"
			},
			user_phoneO_3:{
			...
			user_cellphone:{
				required:"<?php echo lang('user_cellphone_required')?>",
