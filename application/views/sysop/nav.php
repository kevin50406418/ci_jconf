	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="sysop_nav">
			<ul class="nav navbar-nav">
				<!--<li><a href="<?php echo site_url("sysop/setting");?>">系統設定</a></li>-->
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url("sysop/conf");?>">研討會管理</a></li>
						<li><a href="<?php echo site_url("sysop/conf/add");?>">新增研討會</a></li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url("sysop/user/all");?>">使用者管理</a></li>
						<li><a href="<?php echo site_url("sysop/user/add");?>">新增使用者</a></li>
					</ul>
				</li>
				<li><a href="<?php echo site_url("sysop/email");?>"><i class="fa fa-newspaper-o pull-right"></i> 電子郵件樣版</a></li>
				<li><a href="<?php echo site_url("sysop/logout");?>"><i class="fa fa-sign-out pull-right"></i> 登出</a></li>
			</ul>
		</div><!-- /.navbar-collapse -->
	</div><!-- /.container-fluid -->
</nav>
