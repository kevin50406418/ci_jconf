...
<div class="ui segment">
	<a class="pull-right ui button brown" href="<?php echo site_url("sysop/user/all");?>">所有使用者</a>
	<h2>編輯使用者</h2>
	<?php echo form_open("sysop/user/edit/".$user->user_login)?>
	...
	<div class="tabbable-panel">
		<div class="tabbable-line">
			<ul class="nav nav-tabs nav-tabs-center">
				...
				<li> <a href="#tab_ban" data-toggle="tab"> 使用者狀態 </a> </li>
				<li> <a href="<?php echo site_url("sysop/user/reset/".$user->user_login)?>">重設密碼</a> </li>
				<li> <a href="<?php echo site_url("sysop/user/view/".$user->user_login)?>">查看使用者</a> </li>
			</ul>
			<div class="tab-content">
				...
				<div class="tab-pane container-fluid" id="tab_ban">
				</div>
			</div>
		</div>
	</div>
