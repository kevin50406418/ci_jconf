...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div class="text-center row">
			<a href="<?php echo get_url("reviewer",$conf_id,"index")?>" class="btn btn-lg btn-hover btn-olive col-md-2"><i class="fa fa-list fa-4x"></i><br><?php echo lang('reviewer_paper')?></a>
