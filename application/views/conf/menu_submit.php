...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div class="text-center row">
			...
			<?php if($conf_config['conf_most'] == 1 ){?><a href="<?php echo get_url("submit",$conf_id,"most")?>" class="btn btn-lg btn-hover btn-olive col-md-2"><i class="fa fa-university fa-4x"></i><br><?php echo lang('dashboard_most')?></a><?php }?>
