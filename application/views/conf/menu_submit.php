...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div class="text-center row">
			...
			<?php if($this->user_login == "jingxun"){?><a href="<?php echo get_url("submit",$conf_id,"register")?>" class="btn btn-lg btn-hover btn-olive col-md-2"><i class="fa fa-sign-in fa-4x"></i><br><?php echo lang('submit_signup')?></a><?php }?>
