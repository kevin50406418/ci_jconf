...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div class="text-center row">
			...
			<!-- <a href="<?php echo get_url("dashboard",$conf_id,"menu")?>" class="btn btn-lg btn-hover btn-olive col-md-2"><i class="fa fa-bars fa-4x"></i><br>網頁選單(開發中)</a> -->
			...
			<!-- <a href="<?php echo get_url("dashboard",$conf_id,"export")?>" class="btn btn-lg btn-hover btn-olive col-md-2"><i class="fa fa-download fa-4x"></i><br>資料匯出(開發中)</a> -->
			...
			<!--<a href="<?php echo get_url("dashboard",$conf_id,"modules")?>" class="btn btn-lg btn-hover btn-olive col-md-2"><i class="fa fa-cogs fa-4x"></i><br>模組管理(終止開發支援)</a>-->
		</div>
	</div>
</div>