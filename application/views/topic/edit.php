...
<div class="tabbable-panel">
	<div class="tabbable-line">
		<ul class="nav nav-tabs nav-tabs-center">
			...
			<a href="<?php echo get_url("topic",$conf_id,"detail",$paper->sub_id)?>" class="ui button blue pull-right">查看</a>
		</ul>
		<div class="tab-content">
			<?php echo validation_errors('<div class="ui message red">', '</div>');?>
			<div class="tab-pane active container-fluid" id="tab_info">
				<h3>稿件資訊</h3>
				<?php echo form_open(get_url("topic",$conf_id,"edit",$paper->sub_id),array("class"=>"form-horizontal"));?>
			...
			<div class="tab-pane container-fluid" id="tab_file">
				<div class="ui raised segment">
					<h3>稿件檔案</h3>
					<?php echo form_open(get_url("topic",$conf_id,"edit",$paper->sub_id))?>
				...
				<div class="ui raised segment black">
					...
					<table class="table table-bordered form-horizontal">
						<tr>
							...
							<td class="col-sm-10">
								<?php echo form_open_multipart(get_url("topic",$conf_id,"edit",$paper->sub_id),array("class"=>"form-horizontal"));?>
...
$(function() { 
	$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
		localStorage.setItem('topic<?php echo $paper->sub_id?>', $(this).attr('href'));
	});
	var lastTab = localStorage.getItem('topic<?php echo $paper->sub_id?>');
	if (lastTab) {
