...
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
		<div class="radio">
			<label>
				<input name="main_contact" type="radio" required id="main_contact" value="1" checked>主要聯絡人</label>
		</div>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-sm-10">
		<?php echo form_dropdown('user_country[]', $country_list, $user->user_country, 'class="form-control"');?>
	</div>
</div>
