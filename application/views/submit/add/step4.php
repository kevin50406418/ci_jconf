...
<div class="ui blue segment">
	<?php echo form_open_multipart(get_url("submit",$conf_id,"add")."?step=4&upload",array("class"=>"form-horizontal"));?>
...
<div class="ui blue segment">
	...
	<?php echo form_open(get_url("submit",$conf_id,"add")."?step=4&delfile")?>
