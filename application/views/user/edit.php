	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title"><?php echo lang('account')?></h3>
			</div>
			<?php echo form_open(site_url('user/index'),array("id"=>"register"))?>
						...
						<div class="tab-content">
							<div class="tab-pane active container-fluid" id="tab_account">
								...
								<div class="form-group">
									...
									<textarea name="user_org" rows="3" required class="form-control" id="user_org"><?php echo $user->user_org; ?></textarea>
